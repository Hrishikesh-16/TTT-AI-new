...
# Console Board
    ...
    #def empty_sqr(self,row,col):
        #return self.squares[row][col] == 0 # If it is true it provides empty
...
class AI:
    ...
    def minimax(self,board,maximizing):
        ...
        if maximizing:
            max_eval = -100 # any number can be provide which is greater than 0 and 1
            best_move = None
            empty_sqrs = board.get_empty_sqrs()
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN: # By clicking to find out the co-ordinates
              ...
              col = pos[0] // SQSIZE
               ...
               # print(row,col)  # We Manage it from pixel co-ordinates to rows and col as 1,0
              if board.empty_sqr(row,col) and game.running:
                 game.make_move(row,col)

                 if game.isover():
                    game.running = False
               #print(board.squares) # Now we can get player 1 and player 2 into the matrix
               # print(board.squares) # if We print it again and again it didnt print anything  
               # print(game.board.squares) #getting matrix when marking on squares
